// matematica.js - Lógica da página de Matemática
// Depende de gerador.js (deve ser incluído antes)
...
const LevelLibrary = {
    matematica: [
        { 
            ...
            type: 'quantity', 
            numbers: [1,2,3,4,5], 
            instruction: 'Pinte a quantidade de círculos.' 
        },
        { 
            id: 'm2', 
            title: 'M2 · Adição', 
        ...
        { 
            ...
            title: 'M3 · Sequências', 
            type: 'sequence', 
            sequences: [[1,2,'__',4,5],[5,6,7,'__',9],[8,'__',10]], 
        ...
        { 
            ...
            instruction: 'Pinte os grupos de 10 e unidades.' 
        },
        { 
            id: 'm5', 
            title: 'M5 · Comparação', 
            ...
            instruction: 'Circule o maior (ou igual).' 
        },
        { 
            id: 'm6', 
            title: 'M6 · Subtração', 
        ...
        { 
            ...
            type: 'neighbors', 
            centers: [5,10,15,18], 
            instruction: 'Escreva o antes e depois.' 
        }
    ]
};
...
function generateItemsForLevel(level) {
    ...
    // Completa ciclicamente até o tamanho exato
...
function updateParamPanel() {
    ...
    // Anexa eventos para atualizar customParams
...
// Função global para seleção de nível
...
window.onLinesPerPageChange = onLinesPerPageChange; // opcional
